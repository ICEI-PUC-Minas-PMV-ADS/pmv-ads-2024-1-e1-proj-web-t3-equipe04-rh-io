...
window.onload = function () {
    ...
    btnRegister.addEventListener('click', function () {
        const login = document.querySelector('.input-login-register').value;
        const senha = document.querySelector('.input-password-register').value;
        const input_email = document.querySelector('.input-email-register').value;
        const input_name = document.querySelector('.input-nome-register').value;

        if (login == "" || senha == "" || input_email == "" || input_name == "") {
